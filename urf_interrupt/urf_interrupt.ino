...
#include <DueTimer.h>                                 // Header file for TimerOne library

#define trigPin 7                                    // Pin 12 trigger output
#define echoPin 8                                     // Pin 2 Echo input
...
void setup() 
{
  ...
  Timer1.start(TIMER_US);                        // Initialise timer 1
